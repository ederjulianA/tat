<style type="text/css" media="screen">
	...
	<div class="panel panel-smart">				
		<div class="panel-heading">
							...
							<form action="https://gateway.payulatam.com/ppp-web-gateway/" method="post" accept-charset="utf-8">
								...
								<div class="panel-body">
									...
									<dt>Shipment Fee :</dt>
									<?php    $sig = "5hthemedg8dujsa7bo9omdu9at~519941~TestPayU~".Cart::total()."~COP"; $f = md5($sig); ?>
									...
									<input type="hidden" id="vlr_envio_a" name="vlr_envio_a" value="">
										...
										<input name="merchantId"    type="hidden"  value="519941"   >
									  <input name="accountId"     type="hidden"  value="518436" >
									  ...
									  <input name="signature"     type="hidden"  value="{{$f}}"  >
