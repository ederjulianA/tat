		<?php
						if ($conn_access  = odbc_connect("Driver={SQL Server Native Client 10.0};Server=192.168.1.56,1433;Database=erpappweb22proto;", 'sa', 'Somic321')){ 
					   	echo "Conectado correctamente"; 
					   	
					        			        $ssql = "select top 100 * from vistarentaarticulo"; 
