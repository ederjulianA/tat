...
--
-- Servidor: localhost
-- Tiempo de generación: 15-01-2015 a las 00:38:14
...
INSERT INTO `barrios` (`id`, `cod`, `bar_nom`, `created_at`, `updated_at`) VALUES
(1, 'cod1', 'San Francisco', '0000-00-00', '0000-00-00'),
(2, 'cod2', 'Cabecera', '0000-00-00', '0000-00-00'),
(3, 'cod3', 'El poblado', '0000-00-00', '0000-00-00'),
(4, 'cod4', 'Mutis', '0000-00-00', '0000-00-00');
...
INSERT INTO `compra` (`id`, `user_id`, `totalCart`, `total_compra`, `num_items`, `tipo_compra`, `vlr_envio`, `estado_id`, `created_at`, `updated_at`) VALUES
(6, 8, 48000, 53000, 15, 2, 5000, 2, '2015-01-12', '2015-01-14'),
(7, 8, 750000000, 750000000, 100000, 1, 0, 2, '2015-01-12', '2015-01-14'),
(8, 8, 16000, 21000, 5, 2, 5000, 1, '2015-01-13', '2015-01-13');
...
(8, 'demi@gmail.com', '$2y$10$R.tss0EpKJm6g4EOCSWGKu8P2BEjG8xx81UQ8gggJ70TR17bFTnmy', 'EbLH8Dh37Sn0phuUhDcowU1GCW6uiRWifaQAnsnTL7GseeykZ7hvoWqUo2CC', '', 1, 1, 0, '2015-01-08', '2015-01-14'),
