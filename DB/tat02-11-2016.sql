...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2016 a las 00:18:37
...
CREATE TABLE `caracteristicas` (
  `id` int(11) NOT NULL,
  `ArtSec` varchar(20) COLLATE utf8_spanish2_ci NOT NULL,
  `ArtCarSec` int(11) DEFAULT NULL,
  `ArtCarNom` varchar(100) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `ArtCarDetId` int(11) DEFAULT NULL,
  `ArtCarDetDes` varchar(100) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `ArtCarEst` varchar(1) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `ArtCArtDetEst` varchar(1) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `created_at` date NOT NULL,
  `updated_at` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `caracteristicas` (`id`, `ArtSec`, `ArtCarSec`, `ArtCarNom`, `ArtCarDetId`, `ArtCarDetDes`, `ArtCarEst`, `ArtCArtDetEst`, `created_at`, `updated_at`) VALUES
(4, '198722', 1, 'COLOR', 4, 'NEGRO', 'A', NULL, '2016-11-01', '2016-11-01'),
(5, '198722', 1, 'COLOR', 2, 'ROJO', 'A', NULL, '2016-11-01', '2016-11-01'),
(6, '198721', 2, 'TALLAS', 1, 'XS', 'A', NULL, '2016-11-01', '2016-11-01'),
(7, '198721', 2, 'TALLAS', 2, 'S', 'A', NULL, '2016-11-01', '2016-11-01'),
(8, '198722', 1, 'COLOR', 1, 'AMARILLO', 'A', NULL, '2016-11-01', '2016-11-01'),
(10, '198724', 4, 'UNIDAD', 3, 'CAJA', 'A', NULL, '2016-11-01', '2016-11-01');
...
(294, '13', 'CONSOLAS', 'consolas', NULL, '2016-10-28', '2016-10-28', 'X-XCON', '295');
...
(4, 52, 435000, 435000, 3, 2, 0, 2, 0, NULL, NULL, '2016-10-29', '2016-10-29');
...
(4, NULL, NULL, 4, 'CONTROL XBOX ONE NEGRO', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/control-xbox-one-negro_d582ce6af6d84841aaae8f09c44935fc.jpg', 125000, 16, 3, '145000.00000', 435000, 18, '2016-10-29', '2016-10-29');
...
(636, '636', '636', 'NUEVO', 'nuevo', '1', '2016-10-28', '2016-10-28'),
(637, '637', '637', 'XBOX', 'xbox', '295', '2016-10-28', '2016-10-28');
...
(13, '13', 'X', 'Video Juegos', 1, '2016-10-28', '2016-10-28', 'video-juegos');
...
(1, '42726', 'KOTDG034 ', 'SUB9503 MUG PAREJA SUB9503', '405', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'sub9503-mug-pareja-sub9503', 'img/Mantis/def.png', NULL, '9000.00000', '10440.00000', 1, 16, 0, NULL, '2016-10-19', '2016-11-02'),
(2, '42896', 'KOTDP002 ', 'ADORNO SUJADO', '405', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'adorno-sujado', 'img/Mantis/def.png', NULL, '5000.00000', '5800.00000', 1, 16, 500, NULL, '2016-10-19', '2016-11-02'),
(3, '63926', 'UELCO005', 'TELEFONO ALCATEL 208 ROJO', '539', 'RENDIMIENTO AL MÁXIMO\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'telefono-alcatel-208-rojo', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/gsmarena_001_43484799716e4b069d860bbdc084853b.jpg', NULL, '285000.00000', '330600.00000', 1, 16, 2, 1045554512, '2016-10-19', '2016-11-02'),
(4, '63924', 'UELCO003', 'SIMCARD ESTRATEGICA COMCEL', '539', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'simcard-estrategica-comcel', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/4537300_27253fad1ff94090a5d29dd4e7a9519c.jpg', NULL, '2100.00000', '2436.00000', 1, 16, 89, 1045553354, '2016-10-19', '2016-11-02'),
(5, '127173', 'VJADF008', 'R.82706 PIJAMA NINA BATOLA', '601', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'r82706-pijama-nina-batola', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/JB10_dea8c451fa254b53b7edd83c4a4450fc.jpg', NULL, '25000.00000', '29000.00000', 1, 16, 100, 1045554479, '2016-10-19', '2016-11-02'),
(6, '127180', 'VJADF015', 'R.87112 PIJAMA NINA PANTALON', '601', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'r87112-pijama-nina-pantalon', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/cunete-estuco-panel-impadoc_7fcd3119c7f345cca30c6f26ba2eb921.jpg', NULL, '35000.00000', '40600.00000', 1, 16, 0, 1045553386, '2016-10-19', '2016-11-02'),
(7, '63925', 'UELCO004', 'TELEFONO ALCATEL 208 GRIS', '539', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'telefono-alcatel-208-gris', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/viniltex-base-agua-para-uso-interior_e35a2768c84147f0b577be1f796f6243.jpg', NULL, '250000.00000', '290000.00000', 1, 16, 0, 1045553386, '2016-10-19', '2016-11-02'),
(8, '127195', 'VJADF030', 'R.89010 PIJAMA NINO CORTO', '601', 'RENDIMIENTO AL MÁXIMO\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'r89010-pijama-nino-corto', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/5551-3349835_65e55187c4ef449b8d2f94299ee8c585.jpg', NULL, '25000.00000', '29000.00000', 1, 16, 0, 1045565781, '2016-10-19', '2016-11-02'),
(9, '63927', 'UELCO007', 'TELEFONO ALCATEL 255 ROJO', '539', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'telefono-alcatel-255-rojo', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/RA4015551_b57675a6221c495aa13dac87111f1b01.jpg', NULL, '305000.00000', '353800.00000', 1, 16, 2, 1045553389, '2016-10-19', '2016-11-02'),
(10, '127186', 'VJADF021', 'R.83714 PIJAMA NINO BERMUDA', '601', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'r83714-pijama-nino-bermuda', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/4537300_e9b8e6ebeb864f1ba35303f608cf504c.jpg', NULL, '25600.00000', '29696.00000', 1, 16, 0, 1045553388, '2016-10-19', '2016-11-02'),
(11, '42897', 'KOTDP003 ', 'ADORNO MOVIL CHICA', '405', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'adorno-movil-chica', 'img/Mantis/def.png', NULL, '1200.00000', '1392.00000', 1, 16, 490, NULL, '2016-10-19', '2016-11-02'),
(12, '42899', 'KOTDP005 ', 'CAJA OVALADA MEDIANA', '405', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'caja-ovalada-mediana', 'img/Mantis/def.png', NULL, '1800.00000', '2088.00000', 1, 16, 140, NULL, '2016-10-19', '2016-11-02'),
(13, '42898', 'KOTDP004 ', 'CAJA OVALADA GRANDE', '405', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'caja-ovalada-grande', 'img/Mantis/def.png', NULL, '3300.00000', '3828.00000', 1, 16, 100, NULL, '2016-10-19', '2016-11-02'),
(14, '120310', 'VIHLO934', 'R.033244M603 BOXER LEO VERDE OSC', '599', 'RENDIMIENTO AL MÁXIMO\r\nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'r033244m603-boxer-leo-verde-osc', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/MasillaReadyMix JointCompoundParaPlacasDeYeso_6afb7387a2a04dc2b785199a7bfb1eff.jpg', NULL, '12500.00000', '14500.00000', 1, 16, 0, 1045553388, '2016-10-19', '2016-11-02'),
(15, '60573', 'UABMP023', 'R.2008MA BABERO PLASTICO MANGAS', '503', 'RENDIMIENTO AL MÁXIMO     \nEsta moderna Portátil es la indicada. Con un precio accesible y gran cantidad de recursos, no es de extrañar que enamore a todo el mundo, además es de fácil instalación, capaz de brindarte un mundo sin obstáculos, sin complicaciones y atractivo.', 'r2008ma-babero-plastico-mangas', 'img/Mantis/def.png', NULL, '110000.00000', '127600.00000', 1, 16, 0, 1045554483, '2016-10-19', '2016-11-02'),
(16, '198720', 'XB-01', 'XBON ONE 500G', '637', 'XBOX ONE 500 G', 'xbon-one-500g', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/xbox-one_ac1c0e8f718f496aa8b1ecdc2152e9f6.jpg', NULL, '1150000.00000', '1334000.00000', 1, 16, 14, 1045568790, '2016-10-29', '2016-11-02'),
(17, '198721', 'XB-02', 'XBOX ONE 500G GO BLANCO', '637', 'XBOX ONE 500G GO', 'xbox-one-500g-go-blanco', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/xbox-one-blanca_c25a65e9d13d4cf8b9004c1e8916d03f.jpg', NULL, '950000.00000', '1102000.00000', 1, 16, 7, 1045568789, '2016-10-29', '2016-11-02'),
(18, '198722', 'XB-03', 'CONTROL XBOX ONE NEGRO', '637', '<strong>Control</strong> Inalambrico Xbox One, Original\n\nEl control Xbox one est? mejor que nunca, con m?s de 40 innovaciones tecnol?gicas, nuevos disparadores, Impulso, entregas, retroalimentaci?n y dedo preciso para las experiencias m?s realistas. Se ha mejorado los joysticks, D-pad, y los contornos para mejorar la precisi?n y comodidad en las manos. Botones de disparo con estruendo y retroalimentaci?n con precisi?n direccional. Experimenta la acci?n como nunca antes con el mando inal?mbrico Xbox One.', 'control-xbox-one-negro', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/control-xbox-one-negro_d582ce6af6d84841aaae8f09c44935fc.jpg', NULL, '125000.00000', '145000.00000', 1, 16, 15, 1045568791, '2016-10-29', '2016-11-02'),
(20, '198724', 'XB-04', 'FIFA 17 XBOX ONE', '637', 'FIFA 17 Deluxe Edition Xbox One\n\nFIFA 17 es la apuesta por la simulación de fútbol de EA Sports para la temporada 2016-2017. Vuelve toda la emoción de las principales ligas al mundo del videojuego en una entrega donde se promete un mayor grado de personalización, inmersión y competición. Impulsado por Frostbite, asdsdafafafafaefafa  dfsdsfss 30 DIAS DE GARANTIA .CUBRE DEFECTOS DE FABRICA .NO CUBRE MALA MANIPULACION DEL USUARIO FINAL .CORREO SOPORTE : asistknika@gmail.com. ', 'fifa-17-xbox-one', 'http://190.156.239.253:8080/Tiendo/PublicTempStorage/multimedia/xbox-one-7527-8342714-1-product_2d3acc69c95b4a25b1c61d2373dbf47a.jpg', NULL, '170000.00000', '197200.00000', 1, 0, 0, NULL, '2016-11-01', '2016-11-02');
...
(3, '1102365685', 'admin@admin.com', NULL, '$2y$10$qlhwbOAYyq.dRvx6VdQEHuk5aGumJ23AuxbNlUPbFdKD5fiHalUzm', 'ioIT1G6eIvncPhfzoicyqCGGeX9bAMt1i3IL9dixVFj86EdXxEDnUirK5EQh', '', 1, 1, 1, '0000-00-00', '2016-10-29'),
...
(48, '1102365683', 'ederalvarez2091057333@gmail.com', NULL, '$2y$10$m7ZfNBdbKzgjIQQemcljBuENH2mrTmhvjEbYKPDvIbTm3OevqOMuO', NULL, NULL, 1, 1, 0, '2016-09-29', '2016-09-29'),
(49, '123456789', 'ederalvarez209105777@gmail.com', NULL, '$2y$10$PElJmDP.j7b6yW3dYEjskeVkCcKN3wu/J4pIGTo63KJoCOKFOwADK', 'MLblzpaRJWvQaZr6PNhO0yqrBbVjxW2yDRpUKwDl6HWFdJdjvM9FJXDyeDL3', NULL, 1, 1, 0, '2016-10-29', '2016-10-29'),
(51, '456456456', 'ctvez@gmail.com', NULL, '$2y$10$0fB5Morgtz8J8hW2yd5V8Or9b0F9TE4lkZ7O0izL0LGmBcxQdzAjK', 'iM9R2TDSzbNcobS6C3Ev5w85LS9p47nAztrZLyfre0WRIcGudAvMV0y2mwO0', NULL, 1, 1, 0, '2016-10-29', '2016-10-29'),
(52, '123123123', 'jcastro@udi.edu.co', NULL, '$2y$10$BdfXu21kCQ17k2GKepMb/OreT42wbYo8bQPufMKRPl.FzvB/JQtfq', NULL, NULL, 1, 1, 0, '2016-10-29', '2016-10-29'),
(55, '321321321', 'ederalvarez2091057@gmail.com', NULL, '$2y$10$bGJNwLCLQmFDAjOS/bitm.QvYDRwoDr67RH5KGSEGkWTqsHjtZtDm', NULL, NULL, 1, 1, 0, '2016-10-31', '2016-10-31');
...
(46, 49, 1, 'Eder', 'Alvarez', '123456789', 'DEFAULT', 1, 0, NULL, '3013119198', 'Sin comentarios', '2016-10-29', '2016-10-29'),
(48, 51, 1, 'carlos', 'tevez', '456456456', 'DEFAULT', 1, 0, NULL, '3002584545', 'Sin comentarios', '2016-10-29', '2016-10-29'),
(49, 52, 1, 'Jairo', 'Castro', '123123123', 'DEFAULT', 1, 0, NULL, '3002582545', 'Sin comentarios', '2016-10-29', '2016-10-29'),
(52, 55, 1, 'Samuel', 'Etoo', '321321321', 'DEFAULT', 1, 0, NULL, '65585858', 'Sin comentarios', '2016-10-31', '2016-10-31');
